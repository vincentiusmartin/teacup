...
class SitesFinder:
        ...
        with PdfPages(filepath) as pdf:
            for key in seqdict:
                ...
                for pos in mutpos[key]:
                    ax.axvline(pos,color='red',linestyle='dashed',linewidth=1)
                ...
                # ================ FINALIZE ================
                ax.yaxis.set_label_text('log score')
    ...
    def validate_bindsites(self,bindsites,escoresites):
        if len(bindsites) != 2:
