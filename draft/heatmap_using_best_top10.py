...
if __name__=="__main__":
    ...
    output_auc = []
    output_acc = []
    best_top10_auc = ["distance","1mer_A_count","1mer_C_count","3mer_ACC_count","2mer_AA_count",\
                  "2mer_CC_count","2mer_TG_count","3mer_CAT_count","3mer_CCT_count","1mer_G_count"]
    best_top10_acc = ["1mer_C_count","distance","1mer_A_count","1mer_G_count","2mer_GC_count",\
                  "2mer_CA_count","2mer_CC_count","3mer_CAT_count","1mer_T_count","2mer_AA_count"]
    prefix = ["distance", "1mer", "2mer", "3mer"]
    #prefix = ["distance"]
    f = open("heatmap_using_best_top10_output.txt", 'w')
    ...
    for n_est in n_estimators:
        for depth in max_depth:
            ...
            x_acc, y_acc = prepare_data(df, best_top10_acc)
            x_auc, y_auc = prepare_data(df, best_top10_auc)
    ...
    plt.title("AUC Score Heatmap Using Best Top 10 Features")
    plt.xlabel("max_depth")
    plt.ylabel("n_estimators")
    plt.savefig("AUC_heatmap_using_best_top10.png")
    ...
    sns_plot_acc = sns.heatmap(df_acc, annot=True, fmt=".2f",cmap="YlGnBu",xticklabels=max_depth,\
                                yticklabels=n_estimators)
    plt.title("Accuracy Score Heatmap Using Best Top 10 Features")
    plt.xlabel("max_depth")
    plt.ylabel("n_estimators")
    plt.savefig("Acc_heatmap_using_best_top10.png")
