...
if __name__=="__main__":
    ...
    f = open("heatmap_bestparam_top25_output.txt", 'w')
    output_auc = []
    output_acc = []
    ...
    for n_est in n_estimators:
        for depth in max_depth:
            ...
            # get the top 10 only
            sorted_features = sorted_features[:25]

            f.write('The top 25 features are:\n')
    ...
    plt.title("AUC Score Heatmap Top 25 Features")
    plt.xlabel("max_depth")
    plt.ylabel("n_estimators")
    plt.savefig("AUC_heatmap_bestparam_top25.png")
    ...
    sns_plot_acc = sns.heatmap(df_acc, annot=True, fmt=".3f",cmap="YlGnBu",xticklabels=max_depth,\
                                yticklabels=n_estimators)
    plt.title("Accuracy Score Heatmap Top 25 Features")
    plt.xlabel("max_depth")
    plt.ylabel("n_estimators")
    plt.savefig("Acc_heatmap_bestparam_top25.png")
