...
NEW_DATA_PATH = "../data/generated/training_numerical_1mer_2mer_3mer_fracs.csv"
...
if __name__ == "__main__":
    ...
    # will this be fraction or count?
    frac = True
    ...
    for num in k:
        ...
        kmer_dict, comb_output = get_col(num, seq, df['bpos1'].values, df['bpos2'].values, frac)
