...
def display_output(output, names):
    ...
    plt.title('AUC Comparison Best Parameters')
    plt.gcf().subplots_adjust(top=0.85)
    plt.savefig('Boxplot_feature_comb_best_param_auc.png')
...
if __name__=="__main__":
    ...
    comb_dict = {('distance',): [700,2], ('1mer',):[500,20], ('2mer',):[2000,20], ('3mer',):[700,20],\
    ...
    # for acc best param
    # comb_dict = {('distance',): [100,2], ('1mer',):[1000,15], ('2mer',):[2000,5], ('3mer',):[2000,20],\
    ...
    #prefix = ["1mer"]
    f = open("compare_cv_output_best_param_auc.txt", 'w')
    ...
    for i in range(len(prefix)):
        ...
        for comb in itertools.combinations(prefix, i+1):
            ...
            for j in range(100):
                ...
                n_est = comb_dict[comb][0]
                max_depth = comb_dict[comb][1]

                #-----------------if n_est and max_depth are set---------------
                # n_est = 100
                # max_depth = 2

                auc_res = train(x, y, n_est, max_depth)
